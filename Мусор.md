...
$frontendData['linkedFrame'] = $child['linked_frame'] ? [  
    'id'   => $child['linked_frame']['id'] ?? 0,  
    'sku'  => $child['linked_frame']['sku'] ?? '',  
    'image' => $child['linked_frame']['image'] ?? '',  
    'url'  => $child['linked_frame']['url'] ?? '',  
] : [];  
break;