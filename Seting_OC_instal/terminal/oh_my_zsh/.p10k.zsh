# Generated by Powerlevel10k configuration wizard on 2025-03-18 at 18:41 +04.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # статус git
    prompt_char             # символ командной строки
    hostname                # имя хоста
  )
  ...
  typeset -g POWERLEVEL9K_DATE_FOREGROUND=green
