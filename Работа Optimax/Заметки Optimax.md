...
Catalog
	3. Catalog ms все исключения ловаить до запуска контролеров  в файле ExceptionEventSubscriber.php
	4. Напримере аттрибутов как произходит реиндекс в catalog ms 